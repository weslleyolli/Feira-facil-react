    ...
    <div className="w-5/6 h-10 mx-auto mt-8 flex justify-center">
      <div className="w-full rounded-lg flex gap-5">
        <div className="flex items-center w-2/3 bg-gray-200 rounded-lg p-4">
          ...
          <input type="text" placeholder='Procure na banca' className="w-full mt-0 px-2 pt-2 rounded-lg bg-transparent placeholder-gray-400 my-1.5 text-gray-400 outline-none" />
        </div>
        <div className="flex items-center w-1/3 bg-gray-200 rounded-lg">
          ...
          <button className="py-2 px-4 flex-grow bg-transparent rounded-lg text-left border-none text-gray-400">
            Iniciar Chat
          </button>
        </div>
      </div>
